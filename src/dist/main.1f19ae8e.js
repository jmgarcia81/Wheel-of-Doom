...
var btnAddCoder = document.getElementById("btnAddCoder");
var codersDisplay = document.getElementById("coders");
var coderNameInput = document.getElementById("coderName");

function addCoder() {
  var coderNameValue = getCoderNameInput();
...
function createCoderCard(coderName) {
  return "\n        <div class=\"coder\">\n            <img src=\"img/".concat(coderName, ".jpg\" alt=\"Imagen de ").concat(coderName, "\"\">\n            <button class=\"btnDeleteCoder\">X</button>\n        </div>");
}
