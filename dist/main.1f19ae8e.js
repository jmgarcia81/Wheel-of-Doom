...
var codersDisplay = document.querySelector(".coders");

function addCoder() {
  var nombreCoder = "MaxPower";
  codersDisplay.innerHTML += "\n    <div class=\"coder\">\n        <img src=\"img/".concat(nombreCoder, ".jpg\" alt=\"Imagen de ").concat(nombreCoder, "\" style=\"height: 80px;\">\n        <button class=\"btnDeleteCoder\">X</button>\n    </div>");
}
